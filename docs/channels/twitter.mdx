...
3.	Search & Select the channel of your choice from the channels popup
  <Image src="channels/twitter/search-and-select" alt="Bit Assist" w="1046" h="200"/>
 

4.	**Channel Title:** Set the proper Channel Title. Default it's taken, *Twitter*. This Title is descriptive text for visitors.
  <Image src="channels/twitter/channel-title" alt="Bit Assist" w="1046" h="200"/>
 
5.	Input your ***Twitter user ID*** 
  <Image src="channels/twitter/channel-username" alt="Bit Assist" w="1046" h="200"/>
...
9.	Now save the channel by clicking the `Save` button. Then you will see a successful channel-created message.
  ...
  <Image src="channels/twitter/successful-message" alt="Bit Assist" w="1046" h="200"/>
  <Image src="channels/twitter/window-show" alt="Bit Assist" w="1046" h="200"/>
