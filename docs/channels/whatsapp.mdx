...
3.	Search & Select the channel of your choice from the channels popup
  <Image src="channels/whatsapp/search-and-select" alt="Bit Assist" w="1046" h="200"/>
 

4.	**Channel Title:** Set the proper Channel Title. Default it's taken, *WhatsApp*. This Title is descriptive text for visitors.
  <Image src="channels/whatsapp/channel-title" alt="Bit Assist" w="1046" h="200"/>
 
5.	Input your ***whatsapp Phone Number*** and ***Your Message*** 
  <Image src="channels/whatsapp/channel-username" alt="Bit Assist" w="1046" h="200"/>
...
9.	Now save the channel by clicking the `Save` button. Then you will see a successful channel-created message.
  ...
  <Image src="channels/whatsapp/successful-message" alt="Bit Assist" w="1046" h="200"/>
  <Image src="channels/whatsapp/window-sho" alt="Bit Assist" w="1046" h="200"/>
