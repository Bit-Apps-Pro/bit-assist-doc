...
3.	Search & Select the channel of your choice from the channels popup
  <Image src="channels/telegram/search-and-select" alt="Bit Assist" w="1046" h="200"/>
 

4.	**Channel Title:** Set the proper Channel Title. Default it's taken, *Telegram*. This Title is descriptive text for visitors.
  <Image src="channels/telegram/channel-title" alt="Bit Assist" w="1046" h="200"/>
 
5.	Input your ***telegram user name*** 
  <Image src="channels/telegram/channel-username" alt="Bit Assist" w="1046" h="200"/>
...
9.	Now save the channel by clicking the `Save` button. Then you will see a successful channel-created message.
  ...
  <Image src="channels/telegram/successful-message" alt="Bit Assist" w="1046" h="200"/>
  <Image src="channels/telegram/window-show" alt="Bit Assist" w="1046" h="200"/>
